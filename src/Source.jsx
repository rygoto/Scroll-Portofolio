export const imageSources = [
    ...
    },
    {
        ...
        descriptionen: 'Combining Audio visualization and Exploring spheres.When clicked each sphere, the sphere turns and starts Audio visualization.Visualization uses Web audio API and bpm detector.Developed with Babylon.js.',
        descriptionja: 'オーディオビジュアライゼーションとスフィアの探索を組み合わせます。各球をクリックすると、球が回転してオーディオビジュアライゼーションが開始されます。ビジュアライゼーションにはWebオーディオAPIとbpm検出器が使用されます。Babylon.jsで開発されました。',
    ...
    },
    {
        ...
        video: '5.mp4',
        alt: 'Ground-Corps',
        descriptionen: 'Viewing the corps appeared in reality.Add a switching Scenes function, which can lead camera dives into their own vision.Freely switching between real space and virtual space.Developed with Babylon.js.',
        descriptionja: '現実に現れた軍団を見る。カメラが自分のビジョンにダイブすることができるシーン切り替え機能を追加。現実空間と仮想空間を自由に切り替える。Babylon.jsで開発されました。',
